...
use Games::Checkers::DeclareConstant locDirections => [
...
use Games::Checkers::DeclareConstant convertType => [
	#     pawn         king
	[ 0xF0000000, 0x00000000 ],  # white
	[ 0x0000000F, 0x00000000 ],  # black
];

use Games::Checkers::DeclareConstant pawnStep => [
[
	[ NL,  4], [  4,  5], [  5,  6], [  6,  7],
...
use Games::Checkers::DeclareConstant pawnBeat => [
...
use Games::Checkers::DeclareConstant kingStep => [
...
use Games::Checkers::DeclareConstant kingBeat => [
